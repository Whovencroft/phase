...
| `6c-altcost-f` | "Once during each of your turns, you may cast [filter] by paying life equal to its mana value rather than paying its mana cost" (Demon of Fate's Design) | `parse_once_per_turn_pay_life_alt_cost()` | `oracle_static/cost_mod.rs` |
